...
The Terraform-based Universal Installer is designed to be flexible with configuration. Below is an example of a custom `main.tf` that provisions a customized DC/OS 1.10.8 cluster on Azure.
...
| dcos_ip_detect_contents | Allows DC/OS to detect your private IP address. Use this to pass this as an input to the module rather than a file in side your bootstrap node. (recommended) | string | `` | no |
...
| dcos_oauth_enabled | [DC/OS Open Source] Indicates whether to enable authentication for your cluster. (optional) | string | `` | no |
...
| dcos_version | Specifies which DC/OS version instruction to use. Options: `1.9.0`, `1.8.8`, etc. | string | `1.10.8` | no |
