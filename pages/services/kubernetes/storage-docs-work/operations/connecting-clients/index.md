...
kube-control-plane-0-instance.kubernetes-cluster.mesos   Ready     master    44m       v1.13.2
kube-node-0-kubelet.kubernetes-cluster.mesos             Ready     <none>    43m       v1.13.2
```
