...
Now you have configured Edge-LB to connect to your Kubernetes clusters. In the last section, you will [test connections and view the Kubernetes Dashboard](/services/kubernetes/__VERSION__/getting-started/test-connect/) via a web proxy on your browser.
